...
if 'register' not in st.session_state:
    ...
    st.sidebar.warning(
        "NOTE - For better results use Model : 'gpt-4.1-mini','gpt-3.5-turbo','gpt-5-mini'")
    ...
    def study_material(state:  studystate):
        prompt = f"""You are an experienced professional educator and tutor.
            Write a structured, theory-focused educational article on {state['topic']}.
            Requirements:
        ...
        return {"material": response, "material_history": [response]}
    ...
    generate = st.button(label="GENERATE FINAL MATERIAL",
    ...
    insert_in_file = st.button(
        "INSERT MATERIAL INTO FILE", use_container_width=True)
